...
export default function TermsOfServicePage() {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      {/* Header */}
      <header className="border-b border-[oklch(0.92_0.003_260)] bg-white/80 backdrop-blur-sm sticky top-0 z-10">
        <div className="max-w-3xl mx-auto px-6 py-4 flex items-center justify-between">
          <button
            onClick={() => router.back()}
            className="inline-flex items-center gap-2 text-sm text-[oklch(0.45_0.003_260)] hover:text-[oklch(0.16_0.005_260)] transition-colors"
          >
          ...
          <Link href="/" className="inline-flex items-center gap-2">
            ...
            />
            <span className="font-medium text-[oklch(0.16_0.005_260)] text-sm">Agathon</span>
          </Link>
        </div>
      </header>
      ...
      <main className="flex-1">
        <div className="max-w-3xl mx-auto px-6 py-12">
          <h1 className="text-3xl font-semibold text-[oklch(0.16_0.005_260)] mb-2">Terms of Service</h1>
          <p className="text-[oklch(0.45_0.003_260)] mb-10">Last updated: January 24, 2025</p>

          <div className="space-y-8">
            <section>
              <h2 className="text-lg font-semibold text-[oklch(0.16_0.005_260)] mb-3">1. Acceptance of Terms</h2>
              <p className="text-[oklch(0.35_0.005_260)] leading-relaxed">
            ...
            <section>
              <h2 className="text-lg font-semibold text-[oklch(0.16_0.005_260)] mb-3">2. Description of Service</h2>
              <p className="text-[oklch(0.35_0.005_260)] leading-relaxed">
            ...
            <section>
              <h2 className="text-lg font-semibold text-[oklch(0.16_0.005_260)] mb-3">3. User Accounts</h2>
              <p className="text-[oklch(0.35_0.005_260)] leading-relaxed mb-3">To use Agathon, you must:</p>
              <ul className="list-disc list-inside text-[oklch(0.35_0.005_260)] space-y-2 ml-4">
                <li>Create an account with accurate information</li>
                <li>Maintain the security of your account credentials</li>
                <li>Notify us immediately of any unauthorized access</li>
                <li>Be at least 13 years old (or have parental consent)</li>
              </ul>
              <p className="text-[oklch(0.35_0.005_260)] leading-relaxed mt-3">
                You are responsible for all activities that occur under your account.
              </p>
            </section>

            <section>
              <h2 className="text-lg font-semibold text-[oklch(0.16_0.005_260)] mb-3">4. Acceptable Use</h2>
              <p className="text-[oklch(0.35_0.005_260)] leading-relaxed mb-3">You agree not to:</p>
              <ul className="list-disc list-inside text-[oklch(0.35_0.005_260)] space-y-2 ml-4">
            ...
            <section>
              <h2 className="text-lg font-semibold text-[oklch(0.16_0.005_260)] mb-3">5. User Content</h2>
              <p className="text-[oklch(0.35_0.005_260)] leading-relaxed">
            ...
            <section>
              <h2 className="text-lg font-semibold text-[oklch(0.16_0.005_260)] mb-3">6. AI-Generated Content</h2>
              <p className="text-[oklch(0.35_0.005_260)] leading-relaxed">
            ...
            <section>
              <h2 className="text-lg font-semibold text-[oklch(0.16_0.005_260)] mb-3">7. Educational Use</h2>
              <p className="text-[oklch(0.35_0.005_260)] leading-relaxed">
            ...
            <section>
              <h2 className="text-lg font-semibold text-[oklch(0.16_0.005_260)] mb-3">8. Intellectual Property</h2>
              <p className="text-[oklch(0.35_0.005_260)] leading-relaxed">
            ...
            <section>
              <h2 className="text-lg font-semibold text-[oklch(0.16_0.005_260)] mb-3">9. Termination</h2>
              <p className="text-[oklch(0.35_0.005_260)] leading-relaxed">
            ...
            <section>
              <h2 className="text-lg font-semibold text-[oklch(0.16_0.005_260)] mb-3">10. Disclaimer of Warranties</h2>
              <p className="text-[oklch(0.35_0.005_260)] leading-relaxed">
            ...
            <section>
              <h2 className="text-lg font-semibold text-[oklch(0.16_0.005_260)] mb-3">11. Limitation of Liability</h2>
              <p className="text-[oklch(0.35_0.005_260)] leading-relaxed">
            ...
            <section>
              <h2 className="text-lg font-semibold text-[oklch(0.16_0.005_260)] mb-3">12. Changes to Terms</h2>
              <p className="text-[oklch(0.35_0.005_260)] leading-relaxed">
            ...
            <section>
              <h2 className="text-lg font-semibold text-[oklch(0.16_0.005_260)] mb-3">13. Governing Law</h2>
              <p className="text-[oklch(0.35_0.005_260)] leading-relaxed">
            ...
            <section>
              <h2 className="text-lg font-semibold text-[oklch(0.16_0.005_260)] mb-3">14. Contact Us</h2>
              <p className="text-[oklch(0.35_0.005_260)] leading-relaxed">
                If you have any questions about these Terms of Service, please contact us at{' '}
                <a href="mailto:support@agathon.app" className="text-[oklch(0.16_0.005_260)] font-medium hover:underline">
                  support@agathon.app
                </a>
              </p>
            </section>
