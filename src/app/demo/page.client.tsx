  ...
  return (
    <div className="min-h-screen bg-black flex flex-col items-center justify-center">
      ...
      <div className="mt-8 text-center">
        <h1 className="text-2xl font-semibold text-white mb-2">AI-Powered Whiteboard Demo</h1>
        <p className="text-gray-400">Draw problems, get instant feedback, and learn by doing.</p>
      </div>
