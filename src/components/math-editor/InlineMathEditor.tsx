...
export function InlineMathEditor({
 ...
 <span>Press <kbd className="px-1 py-0.5 bg-gray-100 rounded mx-1">Enter</kbd> to save</span>
 <span><kbd className="px-1 py-0.5 bg-gray-100 rounded mx-1">Esc</kbd> to cancel</span>
        </div>
      </div>
    </div>
  );
