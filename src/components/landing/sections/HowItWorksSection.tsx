      ...
      <div className="max-w-[1200px] mx-auto">
        ...
        <div className="space-y-0">
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-20 py-16 border-t border-gray-200">
            <div>
              <span className="text-[13px] text-gray-500 font-medium tracking-wider">01</span>
            </div>
            <div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-20 py-16 border-t border-gray-200">
            <div>
              <span className="text-[13px] text-gray-500 font-medium tracking-wider">02</span>
            </div>
            <div>
              <h3 className="text-[28px] font-normal text-foreground mb-4 tracking-[-0.02em]">
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-20 py-16 border-t border-gray-200">
            <div>
              <span className="text-[13px] text-gray-500 font-medium tracking-wider">03</span>
            </div>
            <div>
              <h3 className="text-[28px] font-normal text-foreground mb-4 tracking-[-0.02em]">
        ...
        <div className="mt-32 pt-20 border-t border-gray-200">
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-32">
            <div>
              <p className="text-[13px] text-gray-500 font-medium mb-6 tracking-wider uppercase">Other AI</p>
