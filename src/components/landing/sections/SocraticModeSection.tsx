  ...
  return (
    <section id="socratic" className="py-32 px-6 lg:px-16 bg-[#1a1a1a]">
      <div className="max-w-[1200px] mx-auto">
        {/* Section Header */}
        <div className="mb-20">
          <p className="text-[13px] text-white/60 font-medium mb-6 tracking-wider uppercase">
            The Socratic Method
          </p>
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-end">
              <div className="max-w-[300px]">
                <p className="text-[12px] text-white/60 mb-2 text-right tracking-wider uppercase">You</p>
            ...
            <div className="flex justify-start">
              <div className="max-w-[320px]">
                <p className="text-[12px] text-white/60 mb-2 tracking-wider uppercase">Agathon</p>
        ...
        <div className="mt-32 pt-20 border-t border-white/10">
          ...
          <p className="text-[14px] text-white/60 mt-8">— Socrates</p>
        </div>
      </div>
    </section>
  );
